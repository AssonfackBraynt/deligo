...
import { ArrowRight, CheckCircle2, Clock, Gavel, MapPin, Package, Truck, UserCheck } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-5xl space-y-5 px-4 py-6">
        ...
        {workflowError && (
          <div className="rounded-lg border border-danger/30 bg-danger/8 px-4 py-2 text-sm text-danger">
            {workflowError}
          </div>
        )}
                  ...
                  <CardContent className="space-y-3 py-4">
                    ...
                    <div className="flex gap-2 pt-1">
                      <Button
                        ...
                        onClick={() => void handleAcceptDirect(r.id)}
                      >
                      ...
                      <Button
                        ...
                        variant="outline"
                        disabled={workflowLoading === r.id}
                        onClick={() => void handleRejectDirect(r.id)}
                      >
                        Decline
                      </Button>
                    </div>
  ...
  return (
    <Card>
      <CardContent className="space-y-3 py-4">
        ...
        {/* Progress stepper — only for active (non-terminal) requests */}
        ...
        {workflowEntry && onWorkflow && (
          <div className="pt-1">
            <Button
              ...
              onClick={() => onWorkflow(workflowEntry.action)}
            >
              <CheckCircle2 size={15} />
  ...
  return (
    <Card>
      <CardContent className="space-y-2 py-4">
        ...
        {offer.message && (
          <p className="rounded bg-muted px-2 py-1 text-xs text-muted-foreground">"{offer.message}"</p>
        )}
      </CardContent>
    </Card>
  );
